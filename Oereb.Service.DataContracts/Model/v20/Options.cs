...
namespace Oereb.Service.DataContracts.Model.v20
{
    ...
    public class Options
    {
        ...
        public Options(string format, string language, string topics, bool geometry, string canton = "", string response = "Specification", bool appendixAttached = false, bool details = false, bool withImages = true, bool cache = true) : this()
        {
        ...
        private bool IsParameterCombinationValid()
        {
            ...
            {
                return (Flavour == Settings.Flavour.Reduced || Flavour == Settings.Flavour.Signed);
            }
            ...
            {
                return Flavour == Settings.Flavour.Reduced && Response == ResponseType.Mimetype; //todo federal query does not support json at this time
            }
